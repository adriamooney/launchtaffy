Accounts.onCreateUser(function(options, user) {
  ...
  /*if (user.services.linkedin) {
    ...
    var genericMsg = "<p>Thank you for singing up for LaunchTaffy. We can't wait to help you get your first sales on LaunchTaffy.</p> <h4>You're probably wondering, 'What next?'</h4> <p>We're just getting started, and we're so happy to have you as one of our founding members. We're busy building new features and getting companies and salespeople on board. </p><p> In the mean time, get your profile ready and we'll be in contact with you about important updates.</p><p> Let us know how we can make you more successful by <b><a href='"+process.env.ROOT_URL+"/contact/'>contacting us</a></b>.</p><p>Sincerely,<br />LaunchTaffy</p>"; 
