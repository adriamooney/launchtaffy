Router.configure({
  ...
  waitOn: function() { 
  	return [Meteor.subscribe('companies'), Meteor.subscribe('users'), Meteor.subscribe('messages'), Meteor.subscribe('sales'), Meteor.subscribe('companyTypeSales'), Meteor.subscribe('news'), Meteor.subscribe('threads'), Meteor.subscribe('leads')];
