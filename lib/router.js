...
Router.onBeforeAction(requireLogin, {except: ['home', 'login', 'companySignup', 'salesSignup', 'terms', 'privacy', 'salesLanding', 'salesLandingV2', 'salesLandingWithForm', 'companyLanding', 'contact', 'blogShow', 'blogIndex']});
