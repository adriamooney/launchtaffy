...
Router.route('/company/:_id', {
    ...
    waitOn: function() { 
      return [subscriptions.subscribe('companies'), subscriptions.subscribe('users'), subscriptions.subscribe('messages'), subscriptions.subscribe('sales'), subscriptions.subscribe('companyTypeSales'), subscriptions.subscribe('threads'), subscriptions.subscribe('leads'), subscriptions.subscribe('quiz')];
